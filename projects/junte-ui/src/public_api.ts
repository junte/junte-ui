...
export * from './lib/components/pagination/page-size/page-size.component';
...
export * from './lib/components/app-layout/app-sub-header/app-sub-header.component';
...
export * from './lib/components/app-layout/app-footer/app-footer.component';
