...
export class UI {
  static icons = {
    ...
    half: FontIcons.half + ':font',
    poop: FontIcons.poop + ':font',
    collections: FontIcons.collections + ':font',
    more: FontIcons.more + ':font',
    overlays: FontIcons.overlays + ':font',
    puzzle: FontIcons.puzzle + ':font',
    charts: FontIcons.charts + ':font',
    crown: FontIcons.crown + ':font',
    direction: FontIcons.direction + ':font',
    pointerLeft: FontIcons.pointerLeft + ':pointer-left',
    pointerUp: FontIcons.pointerUp + ':pointer-up',
    pointerRight: FontIcons.pointerRight + ':pointer-right',
    pointerDown: FontIcons.pointerDown + ':pointer-down',
    hand: FontIcons.hand + ':hand',
    fingerTap: FontIcons.fingerTap + ':finger-tap',
    fingersTap: FontIcons.fingersTap + ':fingers-tap',
    reminder: FontIcons.reminder + ':reminder',
    fingersCrossed: FontIcons.fingersCrossed + ':fingers-crossed',
    fingersVictory: FontIcons.fingersVictory + ':fingers-victory',
    gestureZoom: FontIcons.gestureZoom + ':gesture-zoom',
    gesturePinch: FontIcons.gesturePinch + ':gesture-pinch',
    fingersScrollHorizontal: FontIcons.fingersScrollHorizontal + ':fingers-scroll-horizontal',
    fingersScrollVertical: FontIcons.fingersScrollVertical + ':fingers-scroll-vertical',
    fingersScrollLeft: FontIcons.fingersScrollLeft + ':fingers-scroll-left',
    fingersScrollRight: FontIcons.fingersScrollRight + ':fingers-scroll-right',
    pointerLeft2: FontIcons.pointerLeft2 + ':pointer-left2',
    pointerUp2: FontIcons.pointerUp2 + ':pointer-up2',
    pointerRight2: FontIcons.pointerRight2 + ':pointer-right2',
    pointerDown2: FontIcons.pointerDown2 + ':pointer-down2',
    hand2: FontIcons.hand2 + ':hand2',
    fingerTap2: FontIcons.fingerTap2 + ':finger-tap2',
    fingersTap2: FontIcons.fingersTap2 + ':fingers-tap2',
    reminder2: FontIcons.reminder2 + ':reminder2',
    gestureZoom2: FontIcons.gestureZoom2 + ':gesture-zoom2',
    gesturePinch2: FontIcons.gesturePinch2 + ':gesture-pinch2',
    fingersScrollHorizontal2: FontIcons.fingersScrollHorizontal2 + ':fingers-scroll-horizontal2',
    fingersScrollVertical2: FontIcons.fingersScrollVertical2 + ':fingers-scroll-vertical2',
    fingersScrollLeft2: FontIcons.fingersScrollLeft2 + ':fingers-scroll-left2',
    fingersScrollRight2: FontIcons.fingersScrollRight2 + ':fingers-scroll-right2',
    fingersScrollVertical3: FontIcons.fingersScrollVertical3 + ':fingers-scroll-vertical3',
