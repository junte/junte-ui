export const icons = {
  ...
  // emoji
  evil: 'evil:svg:emoji:emoji',
  laughter: 'laughter:svg:emoji:emoji',
  sad: 'sad:svg:emoji:emoji',
  shocked: 'shocked:svg:emoji:emoji',
  skull: 'skull:svg:emoji:emoji',
  smile: 'smile:svg:emoji:emoji',
  wink: 'evil:svg:emoji:emoji',
  neutral: 'neutral:svg:emoji:emoji',
  // controls
